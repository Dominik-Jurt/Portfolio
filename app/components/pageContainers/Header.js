    ...
    return (
        <header className="bg-gray-800 py-1 sticky top-0 z-50">
            <div className="container mx-auto flex justify-between items-center">
                <div className="text-white text-3xl font-semibold whitespace-nowrap">Dominik Jurt</div>
                <nav className="flex justify-between items-center">
                    ...
                    <div className="lg:hidden">
                        ...
                        {isDropdownOpen && (
                            <div className="absolute top-full left-0 bg-gray-800 border border-gray-700 mt-1 py-2">
